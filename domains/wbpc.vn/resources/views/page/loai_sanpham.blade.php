							...
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-body">
										...
										<br>
										@if ($sp->status == 1)
											<h2 style="color: red">Tình Trang: Còn Hàng</h2>
										@elseif($sp->status==0)
											<h2 style="color: red">Tình Trang: Liên Hệ</h2>
										@endif
									</div>
						...
						@foreach($sp_khac as $sp_k)
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-body">
										<p class="single-item-title"><a href="{{route('chitietsanpham',$sp_k->id)}}">{{$sp_k->name}}</a></p>
										<p class="single-item-price" style="font-size: 18px">
										@if($sp_k->promotion_price !=0)
